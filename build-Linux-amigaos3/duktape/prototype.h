...
duk_ret_t dukky_console___proto(duk_context *ctx);

duk_ret_t dukky_url_search_params___proto(duk_context *ctx);

duk_ret_t dukky_url___proto(duk_context *ctx);

duk_ret_t dukky_event___proto(duk_context *ctx);
...
duk_ret_t dukky_mutation_event___proto(duk_context *ctx);

duk_ret_t dukky_ui_event___proto(duk_context *ctx);
...
duk_ret_t dukky_composition_event___proto(duk_context *ctx);

duk_ret_t dukky_keyboard_event___proto(duk_context *ctx);

duk_ret_t dukky_mouse_event___proto(duk_context *ctx);
...
duk_ret_t dukky_wheel_event___proto(duk_context *ctx);

duk_ret_t dukky_focus_event___proto(duk_context *ctx);

duk_ret_t dukky_css___proto(duk_context *ctx);

duk_ret_t dukky_pseudo_element___proto(duk_context *ctx);

duk_ret_t dukky_svg_element___proto(duk_context *ctx);

duk_ret_t dukky_css_style_declaration___proto(duk_context *ctx);

duk_ret_t dukky_css_rule___proto(duk_context *ctx);
...
duk_ret_t dukky_css_namespace_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_margin_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_grouping_rule___proto(duk_context *ctx);
...
duk_ret_t dukky_css_page_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_media_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_import_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_style_rule___proto(duk_context *ctx);

duk_ret_t dukky_css_rule_list___proto(duk_context *ctx);

duk_ret_t dukky_style_sheet_list___proto(duk_context *ctx);

duk_ret_t dukky_style_sheet___proto(duk_context *ctx);
...
duk_ret_t dukky_css_style_sheet___proto(duk_context *ctx);

duk_ret_t dukky_media_list___proto(duk_context *ctx);

duk_ret_t dukky_event_target___proto(duk_context *ctx);
...
duk_ret_t dukky_node___proto(duk_context *ctx);
...
duk_ret_t dukky_html_element___proto(duk_context *ctx);
...
duk_ret_t dukky_html_font_element___proto(duk_context *ctx);

duk_ret_t dukky_html_directory_element___proto(duk_context *ctx);

duk_ret_t dukky_html_frame_element___proto(duk_context *ctx);

duk_ret_t dukky_html_frame_set_element___proto(duk_context *ctx);

duk_ret_t dukky_html_marquee_element___proto(duk_context *ctx);

duk_ret_t dukky_html_applet_element___proto(duk_context *ctx);

duk_ret_t dukky_storage_event___proto(duk_context *ctx);

duk_ret_t dukky_storage___proto(duk_context *ctx);

duk_ret_t dukky_worker_location___proto(duk_context *ctx);

duk_ret_t dukky_worker_navigator___proto(duk_context *ctx);

duk_ret_t dukky_shared_worker___proto(duk_context *ctx);

duk_ret_t dukky_worker___proto(duk_context *ctx);

duk_ret_t dukky_worker_global_scope___proto(duk_context *ctx);
...
duk_ret_t dukky_shared_worker_global_scope___proto(duk_context *ctx);

duk_ret_t dukky_dedicated_worker_global_scope___proto(duk_context *ctx);

duk_ret_t dukky_broadcast_channel___proto(duk_context *ctx);

duk_ret_t dukky_message_port___proto(duk_context *ctx);

duk_ret_t dukky_message_channel___proto(duk_context *ctx);

duk_ret_t dukky_close_event___proto(duk_context *ctx);

duk_ret_t dukky_web_socket___proto(duk_context *ctx);

duk_ret_t dukky_event_source___proto(duk_context *ctx);

duk_ret_t dukky_message_event___proto(duk_context *ctx);

duk_ret_t dukky_image_bitmap___proto(duk_context *ctx);

duk_ret_t dukky_external___proto(duk_context *ctx);

duk_ret_t dukky_mime_type___proto(duk_context *ctx);

duk_ret_t dukky_plugin___proto(duk_context *ctx);

duk_ret_t dukky_mime_type_array___proto(duk_context *ctx);

duk_ret_t dukky_plugin_array___proto(duk_context *ctx);

duk_ret_t dukky_navigator___proto(duk_context *ctx);

duk_ret_t dukky_error_event___proto(duk_context *ctx);

duk_ret_t dukky_application_cache___proto(duk_context *ctx);

duk_ret_t dukky_before_unload_event___proto(duk_context *ctx);

duk_ret_t dukky_page_transition_event___proto(duk_context *ctx);

duk_ret_t dukky_hash_change_event___proto(duk_context *ctx);

duk_ret_t dukky_pop_state_event___proto(duk_context *ctx);

duk_ret_t dukky_location___proto(duk_context *ctx);

duk_ret_t dukky_history___proto(duk_context *ctx);

duk_ret_t dukky_bar_prop___proto(duk_context *ctx);

duk_ret_t dukky_window___proto(duk_context *ctx);

duk_ret_t dukky_drag_event___proto(duk_context *ctx);

duk_ret_t dukky_data_transfer_item___proto(duk_context *ctx);

duk_ret_t dukky_data_transfer_item_list___proto(duk_context *ctx);

duk_ret_t dukky_data_transfer___proto(duk_context *ctx);

duk_ret_t dukky_touch___proto(duk_context *ctx);

duk_ret_t dukky_path2d___proto(duk_context *ctx);

duk_ret_t dukky_drawing_style___proto(duk_context *ctx);

duk_ret_t dukky_image_data___proto(duk_context *ctx);

duk_ret_t dukky_text_metrics___proto(duk_context *ctx);

duk_ret_t dukky_canvas_pattern___proto(duk_context *ctx);

duk_ret_t dukky_canvas_gradient___proto(duk_context *ctx);

duk_ret_t dukky_canvas_rendering_context2d___proto(duk_context *ctx);

duk_ret_t dukky_canvas_proxy___proto(duk_context *ctx);

duk_ret_t dukky_html_canvas_element___proto(duk_context *ctx);

duk_ret_t dukky_html_template_element___proto(duk_context *ctx);

duk_ret_t dukky_html_script_element___proto(duk_context *ctx);

duk_ret_t dukky_html_dialog_element___proto(duk_context *ctx);

duk_ret_t dukky_related_event___proto(duk_context *ctx);

duk_ret_t dukky_html_menu_item_element___proto(duk_context *ctx);

duk_ret_t dukky_html_menu_element___proto(duk_context *ctx);

duk_ret_t dukky_html_details_element___proto(duk_context *ctx);

duk_ret_t dukky_validity_state___proto(duk_context *ctx);

duk_ret_t dukky_autocomplete_error_event___proto(duk_context *ctx);

duk_ret_t dukky_html_legend_element___proto(duk_context *ctx);

duk_ret_t dukky_html_field_set_element___proto(duk_context *ctx);

duk_ret_t dukky_html_meter_element___proto(duk_context *ctx);

duk_ret_t dukky_html_progress_element___proto(duk_context *ctx);

duk_ret_t dukky_html_output_element___proto(duk_context *ctx);

duk_ret_t dukky_html_keygen_element___proto(duk_context *ctx);

duk_ret_t dukky_html_text_area_element___proto(duk_context *ctx);

duk_ret_t dukky_html_option_element___proto(duk_context *ctx);

duk_ret_t dukky_html_opt_group_element___proto(duk_context *ctx);

duk_ret_t dukky_html_data_list_element___proto(duk_context *ctx);

duk_ret_t dukky_html_select_element___proto(duk_context *ctx);

duk_ret_t dukky_html_button_element___proto(duk_context *ctx);

duk_ret_t dukky_html_input_element___proto(duk_context *ctx);

duk_ret_t dukky_html_label_element___proto(duk_context *ctx);

duk_ret_t dukky_html_form_element___proto(duk_context *ctx);
...
duk_ret_t dukky_html_table_header_cell_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_data_cell_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_row_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_section_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_col_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_caption_element___proto(duk_context *ctx);

duk_ret_t dukky_html_table_element___proto(duk_context *ctx);

duk_ret_t dukky_html_area_element___proto(duk_context *ctx);

duk_ret_t dukky_html_map_element___proto(duk_context *ctx);

duk_ret_t dukky_track_event___proto(duk_context *ctx);

duk_ret_t dukky_time_ranges___proto(duk_context *ctx);

duk_ret_t dukky_text_track_cue___proto(duk_context *ctx);

duk_ret_t dukky_text_track_cue_list___proto(duk_context *ctx);

duk_ret_t dukky_text_track___proto(duk_context *ctx);

duk_ret_t dukky_text_track_list___proto(duk_context *ctx);

duk_ret_t dukky_media_controller___proto(duk_context *ctx);

duk_ret_t dukky_video_track___proto(duk_context *ctx);

duk_ret_t dukky_video_track_list___proto(duk_context *ctx);

duk_ret_t dukky_audio_track___proto(duk_context *ctx);

duk_ret_t dukky_audio_track_list___proto(duk_context *ctx);

duk_ret_t dukky_media_error___proto(duk_context *ctx);

duk_ret_t dukky_html_media_element___proto(duk_context *ctx);
...
duk_ret_t dukky_html_track_element___proto(duk_context *ctx);

duk_ret_t dukky_html_audio_element___proto(duk_context *ctx);

duk_ret_t dukky_html_video_element___proto(duk_context *ctx);

duk_ret_t dukky_html_param_element___proto(duk_context *ctx);

duk_ret_t dukky_html_object_element___proto(duk_context *ctx);

duk_ret_t dukky_html_embed_element___proto(duk_context *ctx);

duk_ret_t dukky_html_iframe_element___proto(duk_context *ctx);

duk_ret_t dukky_html_image_element___proto(duk_context *ctx);

duk_ret_t dukky_html_source_element___proto(duk_context *ctx);

duk_ret_t dukky_html_picture_element___proto(duk_context *ctx);

duk_ret_t dukky_html_mod_element___proto(duk_context *ctx);

duk_ret_t dukky_html_br_element___proto(duk_context *ctx);

duk_ret_t dukky_html_span_element___proto(duk_context *ctx);

duk_ret_t dukky_html_time_element___proto(duk_context *ctx);

duk_ret_t dukky_html_data_element___proto(duk_context *ctx);

duk_ret_t dukky_html_anchor_element___proto(duk_context *ctx);

duk_ret_t dukky_html_div_element___proto(duk_context *ctx);

duk_ret_t dukky_html_dlist_element___proto(duk_context *ctx);

duk_ret_t dukky_html_li_element___proto(duk_context *ctx);

duk_ret_t dukky_html_ulist_element___proto(duk_context *ctx);

duk_ret_t dukky_html_olist_element___proto(duk_context *ctx);

duk_ret_t dukky_html_quote_element___proto(duk_context *ctx);

duk_ret_t dukky_html_pre_element___proto(duk_context *ctx);

duk_ret_t dukky_html_hr_element___proto(duk_context *ctx);

duk_ret_t dukky_html_paragraph_element___proto(duk_context *ctx);

duk_ret_t dukky_html_heading_element___proto(duk_context *ctx);

duk_ret_t dukky_html_body_element___proto(duk_context *ctx);

duk_ret_t dukky_html_style_element___proto(duk_context *ctx);

duk_ret_t dukky_html_meta_element___proto(duk_context *ctx);

duk_ret_t dukky_html_link_element___proto(duk_context *ctx);

duk_ret_t dukky_html_base_element___proto(duk_context *ctx);

duk_ret_t dukky_html_title_element___proto(duk_context *ctx);

duk_ret_t dukky_html_head_element___proto(duk_context *ctx);

duk_ret_t dukky_html_html_element___proto(duk_context *ctx);

duk_ret_t dukky_html_unknown_element___proto(duk_context *ctx);

duk_ret_t dukky_dom_element_map___proto(duk_context *ctx);

duk_ret_t dukky_dom_string_map___proto(duk_context *ctx);

duk_ret_t dukky_html_collection___proto(duk_context *ctx);
...
duk_ret_t dukky_html_options_collection___proto(duk_context *ctx);

duk_ret_t dukky_node_list___proto(duk_context *ctx);
...
duk_ret_t dukky_html_form_controls_collection___proto(duk_context *ctx);

duk_ret_t dukky_html_all_collection___proto(duk_context *ctx);

duk_ret_t dukky_xml_serializer___proto(duk_context *ctx);

duk_ret_t dukky_dom_parser___proto(duk_context *ctx);

duk_ret_t dukky_dom_token_list___proto(duk_context *ctx);
...
duk_ret_t dukky_dom_settable_token_list___proto(duk_context *ctx);

duk_ret_t dukky_node_filter___proto(duk_context *ctx);

duk_ret_t dukky_tree_walker___proto(duk_context *ctx);

duk_ret_t dukky_node_iterator___proto(duk_context *ctx);

duk_ret_t dukky_range___proto(duk_context *ctx);

duk_ret_t dukky_character_data___proto(duk_context *ctx);
...
duk_ret_t dukky_comment___proto(duk_context *ctx);

duk_ret_t dukky_processing_instruction___proto(duk_context *ctx);

duk_ret_t dukky_text___proto(duk_context *ctx);

duk_ret_t dukky_attr___proto(duk_context *ctx);

duk_ret_t dukky_named_node_map___proto(duk_context *ctx);

duk_ret_t dukky_dom_implementation___proto(duk_context *ctx);

duk_ret_t dukky_document___proto(duk_context *ctx);
...
duk_ret_t dukky_xml_document___proto(duk_context *ctx);

duk_ret_t dukky_mutation_record___proto(duk_context *ctx);

duk_ret_t dukky_mutation_observer___proto(duk_context *ctx);

duk_ret_t dukky_document_type___proto(duk_context *ctx);

duk_ret_t dukky_document_fragment___proto(duk_context *ctx);

duk_ret_t dukky_event_listener___proto(duk_context *ctx);

duk_ret_t dukky_custom_event___proto(duk_context *ctx);
