...
} html_options_collection_private_t;
...
} radio_node_list_private_t;

/* Private data for HTMLFormControlsCollection interface */
typedef struct {
	html_collection_private_t parent;
} html_form_controls_collection_private_t;
...
} dom_settable_token_list_private_t;
...
typedef struct {
	character_data_private_t parent;
} processing_instruction_private_t;
...
typedef struct {
	node_private_t parent;
} document_type_private_t;

/* Private data for DocumentFragment interface */
typedef struct {
	node_private_t parent;
} document_fragment_private_t;
