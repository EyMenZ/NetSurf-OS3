...
duk_bool_t
dukky_canvas_rendering_context2d_settings_get_alpha(duk_context *ctx, duk_idx_t idx)
{
	duk_bool_t ret = true; /* Default value of alpha */
	/* ... obj@idx ... */
	duk_get_prop_string(ctx, idx, "alpha");
